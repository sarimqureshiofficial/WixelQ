...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "WixelQ — Free QR Code Generator" },
      { name: "description", content: "Create beautiful, high-resolution QR codes for free. Custom colors, logos, WiFi, WhatsApp, vCards, PDFs and more." },
      { property: "og:site_name", content: "WixelQ" },
